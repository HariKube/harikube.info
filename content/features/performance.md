...
{{< features-section 
    ...
    description="While HariKube's performance is crucial, maintaining a low overall error rate is equally important to ensure reliability and user trust. The next bechmark shows that the single database setup had 6,210 errors out of 160,000 requests (~3.9% error rate), compared to 0 errors generated by HariKube."
>}}
...
{{< feature
    ...
    badge="Single MySQL instance"
    badgeColor="#db2777"
    image="/images/features/gcp_compute_600_10000_1731680855.json_http_req_duration_chart.png"
    buttonText=""
    buttonLink=""
    features="Average response time: ~620 ms, Maximum response time: ~3500 ms"
    imagePosition="right"
>}}
...
{{< feature
    ...
    buttonText=""
    buttonLink=""
    features="Average response time: ~200 ms, Maximum response time: ~1600 ms"
    imagePosition="left"
>}}
...
#### [<-- Developer Experience](/features/developer-experience/) | [Consistency -->](/features/consistency/)